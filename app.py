    ...
    html.Div([
        ...
        html.Div([
            html.Img(src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Facebook_logo_%28square%29.png/240px-Facebook_logo_%28square%29.png",
                     style={"width": "50px"}),
            html.H2(id='facebook-visit'),
            html.H2(id="facebook-duration")
        ]),
        html.Div([
            html.Img(src="data:image/jpeg;base64,",
                     style={"width": "50px"}),
            html.H2(id='instagram-visit'),
            html.H2(id="instagram-duration")
        ]),
        html.Div([
            html.Img(src="https://logos-marcas.com/wp-content/uploads/2020/04/Twitter-Logo.png",
                     style={"width": "100px"}),
            html.H2(id='twitter-visit'),
            html.H2(id="twitter-duration")
        ]),
...
@app.callback(
    ...
    Output('facebook-duration', 'children'),
    Output('instagram-duration', 'children'),
    Output('twitter-duration', 'children'), 
...
def update_figures(start_date_selected, end_date_selected, social_networks_selected, devices_selected):
    ...
    total_duration = round(
        df.loc[(df.social_network.isin(social_networks_selected)) &
            (df.device.isin(devices_selected)) &
            (df.datetime >= start_date_selected) &
            (df.datetime <= end_date_selected)]
    ...
    facebook_duration = round(
    df.loc[(df.social_network == 'facebook') &
            (df.device.isin(devices_selected)) &
            (df.datetime >= start_date_selected) &
            (df.datetime <= end_date_selected), 'minutes']
    .mean(),2)

    twitter_duration = round(
    df.loc[(df.social_network == 'twitter') &
            (df.device.isin(devices_selected)) &
            (df.datetime >= start_date_selected) &
            (df.datetime <= end_date_selected), 'minutes']
    .mean(),2)

    instagram_duration = round(
    df.loc[(df.social_network == 'instagram') &
            (df.device.isin(devices_selected)) &
            (df.datetime >= start_date_selected) &
            (df.datetime <= end_date_selected), 'minutes']
    .mean(),2)

    return total_visit, facebook_visit, instagram_visit, twitter_visit, total_visit_fig, total_visit_social_network_fig, world_map_fig, devices_pie_fig, instagram_duration, twitter_duration, facebook_duration, total_duration
